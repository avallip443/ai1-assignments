...
hasAccount(ada_lovelace, cibc, 500).
...
lives(tom_cruise, winnipeg).
lives(johnny_depp, new_york).
lives(jim_carrey, toronto).
lives(elon_musk, montreal).
lives(beyonce, london).
lives(rihanna, tokyo).
lives(bill_gates, toronto).
lives(tom_holland, new_york).
